...
export const AUGMENT_CONFIG = {
  ...
  turret: {
    thermite: { burn: { dpsPct: 0.35, duration: 2.0 } },
    plague: {
      slowMult: 0.75,
      slowDuration: 0.45,
      pool: { interval: 1.0, radius: 48, life: 2.0, dpsMult: 0.22, tick: 0.30, maxPerTurret: 2 },
    },
  },
  arc: {
...
export const WEAPON_CONFIG = {
  ...
  turret: {
    ...
    widthPerLevel: 2.4,
    turnRateBaseDeg: 170,
    turnRatePerLevelDeg: 12,
    countLevels: [1, 3, 6],
    maxActive: 3,
    spawnRadius: 58,
    bodyRadius: 12,
    retargetInterval: 0.20,
    alignmentAngle: 0.34,
    powerDmgMult: 1.22,
    powerCdMult: 0.86,
    crit: { base: 0.10, perLevel: 0.012, multBase: 1.65, multPerLevel: 0.05 },
    maxLevel: 8,
  },
};
...
export const OBSTACLE_CONFIG = {
  ...
  forests: { count: 2660, sizeMin: 20, sizeMax: 34, hp: 50 },
  rocks: {
    count: 1620,
    sizeMin: 34,
    sizeMax: 62,
    hp: 420,
    ridgeChance: 0.55,
    largeRidgeChance: 0.24,
    ridgeNodesMin: 5,
    ridgeNodesMax: 7,
    largeRidgeNodesMin: 8,
    largeRidgeNodesMax: 11,
    ridgeStepMin: 60,
    ridgeStepMax: 90,
    largeRidgeStepMin: 72,
    largeRidgeStepMax: 100,
    ridgeJitter: 20,
    largeRidgeJitter: 26,
    largePileChance: 0.2,
    pileNodesMin: 4,
