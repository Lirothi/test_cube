...
extern const Profiler::ScopeNameKey kPassSkyDistant;
extern const Profiler::ScopeNameKey kPassSkyEnvironment;
...
extern const Profiler::ScopeNameKey kPassCloudNoise;    // plan C1: the noise set (seed-dirty)
