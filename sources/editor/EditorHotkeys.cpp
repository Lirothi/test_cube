...
namespace
{
    ...
    constexpr ShortcutBinding kShortcutBindings[] =
    {
        ...
        { "End Bury",              ImGuiKey_End,      ShortcutModifiers::Plain,   ShortcutAction::BurySelectionBelowSurface },
        ...
        EditorHotkeyActions& actions)
    {
        ...
        case ShortcutAction::FrameScene:
            ...
            break;
        case ShortcutAction::BurySelectionBelowSurface:
            actions.burySelectionBelowSurface = true;
            break;
