...
public:
    ...
    ID3D12Resource* Backbuffer(UINT index) const { return index < render::kFrameCount ? renderTargets_[index].Get() : nullptr; }
...
private:
    ...
    Microsoft::WRL::ComPtr<ID3D12Resource> renderTargets_[render::kFrameCount];
