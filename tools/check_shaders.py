...
COMPUTE_ENTRIES = [
    ...
    ("exposure_bilateral_cs.hlsl", "CSMain"),
...
GRAPHICS_ENTRIES = [
    ...
    # B6.1: the one fog application for the opaque scene and the water (fog_apply.hlsl).
    ("fog_apply.hlsl", "vs_6_0", "VSMain", [], ""),
    ("fog_apply.hlsl", "ps_6_0", "PSMain", [], ""),
